...
**How effectively can a low-cost Arduino-based photometer monitor changes in light intensity and, when combined with environmental measurements, determine suitable observing conditions?**
...
* Resistors
* Jumper wires
* LED/light source for photometer calibration
\
### Optional Future Components:
* Dedicated photodiode/light sensor
* Rain sensor
* SD card module
* Telescope mount
\
